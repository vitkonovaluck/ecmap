        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <?php }?>
              <form name="forma_1" action="<?php echo base_url();?>Login/fogot1" method="post">
                  <div class="form-group">
                    <label for="email" class="sr-only">Телефон</label>
                    <input type="number" name="email" id="email" class="form-control" placeholder="Номер телефону" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required value="0634936376">
                  </div>
